...
Ces systèmes asymétriques reposent sur la difficulté de résoudre des problèmes mathématiques dits
« difficiles ».
Or, ces problèmes, comme le problème du logarithme discret ou le problème de la factorisation de
grands entiers, pourraient ne plus être suffisamment difficiles dans certaines conditions liées au
...
C’est pourquoi il est impératif de parer à cette menace et de trouver à tous les systèmes dits « classiques » des adaptations résistantes à ces possibilités de calculs potentielles, qui soient suffisamment efficaces pour être utilisées dans le monde réel.
