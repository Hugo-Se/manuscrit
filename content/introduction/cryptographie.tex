...
%Ainsi, un de ces correspondants, était naturellement en mesure de produire un chiffré qui ne soit {\it a priori\/} pas distingable du chiffré d’un autre
...
%qu’un texte serait qu’en chacune de ses occurences dans le texte d’origine, la lettre {\it h\/} se verrait remplacer par la lettre {\it f}.
...
%Cette identité entre ces données techniques est ce qui a permis de qualifier de {\it symétrique\/} ce
...
Prenons en exemple le système AES\footnote{Le sigle AES correspond à « {\it advanced encryption
...
C’est ce que permet la cryptographie {\it asymétrique}.
