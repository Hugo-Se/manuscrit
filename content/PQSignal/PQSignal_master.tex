...
\begin{refsegment}
\chapterquote{Formal Verification of a Post-Quantum Signal Protocol with Tamarin}{« la cryptologie n’est plus seulement la science du secret mais aussi la science de la confiance\footnote{~« cryptology is no longer only the science of secrecy, but also the science of trust »} »}{\emph{Discours au CNRS}}{\newline Jacques Stern} \label{cha:PQSignal}
